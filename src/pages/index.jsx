  ...
  return (
    <html className={styles.html}>
      <head>
        ...
        <title>سینا نخعی - مهندس نرم‌افزار</title>
        <meta name="description" content="تمرکز بر خلق تجربه‌های وب بصری و کارآمد" />
      </head>
          ...
          <main className={styles.main}>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.projectGrid}>
                <ProjectCard
                  videoSrc="/videos/motion-primitives-pro.mp4"
                ...
                />
                <ProjectCard
                  videoSrc="/videos/motion-primitives.mp4"
